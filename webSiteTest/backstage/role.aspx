...
<asp:Content ID="Content1" ContentPlaceHolderID="CPH1" runat="Server">
    <div class="container">
        ...
        <form id="fomr1" runat="server">
            <asp:GridView ID="gvRoles" runat="server" CssClass="table table-bordered table-hover" AutoGenerateColumns="False" AllowPaging="True" OnPageIndexChanging="gvRoles_PageIndexChanging">
