...
<asp:Content ID="Content1" ContentPlaceHolderID="CPH1" runat="Server">
    <div class="container">
        <div class="page-header">
            <span class="glyphicon glyphicon-minus" aria-hidden="true"></span> 刪除人員資料
        </div>
        <form id="fomr1" runat="server">
            ...
            <br />
            <asp:Button ID="btndeleteUser" runat="server" OnClick="btndeleteUser_Click" Text="刪除" CssClass="btn btn-danger" />
        </form>
        <br/>
